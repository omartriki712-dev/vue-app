<template>
  ...
  >
    <header class="h-20 flex items-center px-5 gap-3 overflow-hidden">
      ...
      >
        <strong class="text-[#221b4c] text-[13px] font-semibold leading-tight truncate">Espace Administration</strong>
    ...
    <nav class="flex-1 px-3 py-4 flex flex-col gap-1">
      <button
        ...
        class="flex items-center gap-3 h-12 px-3 rounded-xl font-medium text-sm transition-all duration-200 w-full"
